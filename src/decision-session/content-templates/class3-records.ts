...
export const ABSENCE_PROMPT_CONTEXT_RECORD: ContentTemplateRecord = {
  ...
  levelForms: {
    ...
    4: form("Audit the context behind what was just built: which prompts ran without the spec, the architecture, or the acceptance criteria — and inject the missing context before each next step.", "Beyond one prompt: every under-context prompt identified and its context injected."),
